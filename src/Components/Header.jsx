...
import SellButton from "../Images/sell.png"
  ...
  return (
    <div className="header_component">
      <div className="header__controlLogo">
        <Link to="/">
          <img src={OlxLogo} alt="Olx-Logo" width="50" height="30" />
        </Link>
      </div>
        ...
        <div>
          {userdata.user === true ? (
            <Link to="/sell" style={{ textDecoration: "none" }}>
              <img className="sell__button" src={SellButton}/>
            </Link>
          ) : (
            <img className="sell__button" src={SellButton} onClick={handleOpenSell}/>
          )}
        </div>
      </div>
